...
**Atata.Testcontainers** is a .NET library that adds Docker container sessions to [Atata](https://github.com/atata-framework/atata) using Testcontainers library.
